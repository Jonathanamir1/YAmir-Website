...
const Hero = () => {
	return (
		<div className=' pt-36 '>
			<div className='h-screen w-full dark:bg-primary bg-secondary  dark:bg-grid-white/[0.02] bg-grid-black/[0.2] absolute flex items-center justify-center top-0 left-0'>
			...
			<div className='flex justify-left relative  my-20 z-10 l '>
			...
			<div className='relative'>
				...
				<div className='absolute bottom-0 right-0 opacity-0 lg:opacity-100 xl:-right-10 2xl:-right-28'>
					<Image
						src='/yamir-portrait.png'
						alt='Your Portrait'
						width={350}
						height={400}
						className='object-cover transition-all duration-1000 ease-in-out origin-bottom animate-scaleUp hover:scale-105'
					/>
				</div>
			</div>
			<Spotlight />
